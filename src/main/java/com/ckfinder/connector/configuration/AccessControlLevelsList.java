...
/**
 * Custom {@link java.util.ArrayList} used to manage ACLs in application. The
 * list also manages the state of ACL entries in {@code AccesControlUtil} class
 * by removing them from that class if list is marked as modified.<br>
 * Please note that when adding/removing items from existing
 * {@code AccessControlLevelsList} or creating new
 * {@code AccessControlLevelsList} in
 ...
 *
 * @param <E> type of elelmens which will be kept in
 * {@code AccessControlLevelsList}
 */
public class AccessControlLevelsList<E> extends ArrayList<E> {
     ...
     *
     * @param modified marker indicating whether ACL entries in
     * {@code AccesControlUtil} should be reset. This parameter should be set to
     * true whenever new list is created in
     * {@link com.ckfinder.connector.configuration.Configuration#prepareConfigurationForRequest(javax.servlet.http.HttpServletRequest)}
     * or elements are added/removed from existing
     * {@code AccessControlLevelsList}.
     */
    ...
    /**
     * Appends the specified element to the end of this list and resets ACL
     * entries in {@code AccesControlUtil} if necessary.
     *
     ...
     * elements to the right (adds one to their indices). This method also
     * resets ACL entries in {@code AccesControlUtil} if necessary.
     *
     ...
     * or elements are added/removed from existing
     * {@code AccessControlLevelsList}.
     * @throws IndexOutOfBoundsException when the index is out of range (index
     * lower than 0 or greater than list size).
     */
     ...
     * This method also resets ACL entries in {@code AccesControlUtil} if
     * necessary.
     *
     ...
     * method also resets ACL entries in {@code AccesControlUtil} if necessary.
     *
     ...
     * specified collection. This method also resets ACL entries in
    ...
    /**
     * Resets configuration and ACL entries in {@code AccesControlUtil}
     * instance.
     */
