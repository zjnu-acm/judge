...
public interface ProblemMapper {
    ...
    @Update("<script>UPDATE problem p "
            ...
            + "</if>"
            + "<if test='lang!=null and lang!=&quot;&quot;'>"
            + "pi.title=nullif(#{p.title},''),"
            + "pi.description=nullif(#{p.description},''),"
            + "pi.input=nullif(#{p.input},''),"
            + "pi.output=nullif(#{p.output},''),"
            + "pi.hint=nullif(#{p.hint},''),"
            + "pi.source=nullif(#{p.source},''),"
            + "</if>"
