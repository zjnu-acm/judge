...
public class ContestManagerController {
    ...
    public String addProblem(HttpServletRequest request,
        ...
        if (contest.isEnded()) {
            throw new MessageException("Contest is ended, can't add problem now");
        }
    ...
    public String deleteProblem(HttpServletRequest request,
        ...
        Contest contest = getContest(contestId);
        if (contest.isEnded()) {
            throw new MessageException("Contest is ended, can't delete problem now");
        }
        if (contest.isStarted()) {
            throw new MessageException("Contest is started, can't delete problem now");
        }
        synchronized (contestLock) {
